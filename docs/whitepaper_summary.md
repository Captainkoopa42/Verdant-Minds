...
Across seeded runs, emergent-to-emergent edges are strongly backward-oriented in time: newer emergent concepts preferentially link to older emergent concepts. Replication over 20 seeds produced 20/20 runs with shuffle-null z-scores above 2 (mean 2.96 ± 0.86), with deep-run confirmation under both shuffle and degree-preserving null models.
