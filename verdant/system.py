...
class VerdantSystem:
    ...
    def save_state(self, path: str) -> None:
        ...
        state: Dict[str, Any] = {
            ...
            "kings": {
                ...
                "council": self.council.to_state_dict(),
            },
            "extra": {
                "t_g": self._t_g,
                "cycle_count": self._cycle_count,
    ...
    def load_state(self, path: str) -> None:
        ...
        # Must set before body so thaw()/shard paths resolve relative to the
        # real checkpoint, not the constructor default (/tmp/...).
        self._checkpoint_path = path
        state = load_state_json(path)
        ...
        # Restore kings + council (council was historically omitted, causing
        # influence_weights to reset every session).
        ...
        if "council" in kings and isinstance(kings["council"], dict):
            self.council.from_state_dict(kings["council"])
        # Restore extra
